...
class RestaurantController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('starting_time', __('Starting time'));
        $grid->column('ending_time', __('Ending time'));
        $grid->column('price', __('Price'))->sortable()->sortable();
    ...
    protected function detail($id)
    {
        ...
        $show->field('ending_time', __('Ending time'));
    ...
    protected function form()
    {
        ...
        $form->time('starting_time', __('Starting time'))->default(date('H:i:s'));
        $form->time('ending_time', __('Ending time'))->default(date('H:i:s'));
